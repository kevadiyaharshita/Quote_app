import '../modals/quotes_modal.dart';
...
List<Map> allQuoteData = [
  ...
  {"quote": "In art the best is good enough.", "author": "Johann Wolfgang von Goethe", "category": "art"},
  {"quote": "Art must take reality by surprise.", "author": "Francoise Sagan", "category": "art"},
  {
    "quote": "Ability is the art of getting credit for all the home runs somebody else hits.",
    "author": "Casey Stengel",
    "category": "art"
  },
  {"quote": "Acting is not being emotional, but being able to express emotion.", "author": "Reid, Kate", "category": "art"},
  {
  ...
  {"quote": "My trade and art is to live.", "author": "Michel de Montaigne", "category": "art"},
  {"quote": "Rhetoric is the art of ruling the minds of men.", "author": "Plato", "category": "art"},
  {
  ...
  {"quote": "I'm taking a bit of a wait-and-see attitude towards 3D.", "author": "Christopher Nolan", "category": "attitude"},
  {
    "quote":
  ...
  {"quote": "Courage is a mean with regard to fear and confidence.", "author": "Aristotle", "category": "courage"},
  {
